<template>
    <div>
            ...
            <div class="letter-hero_wrapper">
                <div class="letter-hero_details">
                    <div class="title_block">
                        <div class="blue-text_span">Gardalisa | Real Estate</div>
                    </div>
                ...
                <div class="hero-image_wrapper">
                    <div class="hero-image_block">
                        <img src="/assets/images/projects/673a508fbd397ea38a1e774d_gardalisa_gienhw.webp" loading="lazy"
        ...
        <div class="project-content_section">
                    ...
                    <div class="article-block">
                        ...
                        <div class="header_content">
                            <div class="w-richtext">
                                <p>
                                    We are in the real-estate website. Always difficult to make
                                    unique. We tried, with excellent results 🙂
                                </p>
                            </div>
                        </div>
                        <div class="article-image_block">
                            <img src="/assets/images/projects/673a508fbd397ea38a1e7753_LD_Gardalisa_Presentazione-05-768x543_yfeofu.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                    <div class="article-block">
                        <div class="article-header">
                            <div>The customer</div>
                            <div class="cc-underline quarter-width"></div>
                        </div>
                        <div class="header_content">
                            <div class="w-richtext">
                                <p>
                                    Gardalisa s.r.l. | prestige solutions is a property finder
                                    that was created in response to the explicit needs of its
                                    customers, entrusting the finalization of a real estate
                                    process to a single interlocutor: investing, building and
                                    implementing a project. With a single goal: excellence.
                                    Gardalisa s.r.l. considers real estate mediation a
                                    fundamental part of the process but not sufficient: the
                                    starting or ending point of a purchase or sale path is
                                    fulfilled thanks to a pragmatic and solution-oriented
                                    approach.
                                </p>
                            </div>
                        </div>
                        <div class="article-image_block">
                            <img src="/assets/images/projects/673a508fbd397ea38a1e7750_LD_Gardalisa_Presentazione-15-768x543_lvoziq.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                    <div class="article-block">
                        <div class="article-header">
                            <div>The Brand: the logo design and the payoff</div>
                            <div class="cc-underline quarter-width"></div>
                        </div>
                        <div class="header_content">
                            <div class="w-richtext">
                                <h6>The payoff: prestige solutions</h6>
                                <p>
                                    An extremely direct and simple payoff. If the name of the
                                    company creates mystery without openly declaring the
                                    entrepreneurial sector of Gardalisa, the payoff restores
                                    order and explains everything. The words that make up the
                                    payoff are simple but surgically chosen prestige (of great
                                    charm, charismatic, unique) + solutions (understood as
                                    housing solutions but also, even better, as solutions, i.e.
                                    the methods of approaching a request, a problem, to indicate
                                    Gardalisa's singular and unique approach in solving any
                                    desire).
                                </p>
                                <h6>Logo design</h6>
                                <p>
                                    The key idea of this proposal revolves around the concept of
                                    refinement, luxury and exclusivity.
                                </p>
                                <p>
                                    It is not for everyone to be able to enjoy the fabulous
                                    views of Lake Garda, let alone enjoy them from their private
                                    home. Gardalisa is what it offers: an exclusive and
                                    tailor-made space, responding to the most refined needs.
                                </p>
                            </div>
                        </div>
                        <div class="article-image_block">
                            <img src="/assets/images/projects/673a508fbd397ea38a1e7743_Gardalisa_GoogleMyBusiness_cover_01-A-768x432_kaeb9e.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                    <div class="article-block">
                        <div class="article-header">
                            <div>Web Design, Copywriting and Digital Marketing</div>
                            <div class="cc-underline quarter-width"></div>
                        </div>
                        <div class="header_content">
                            <div class="w-richtext">
                                <p>
                                    After the study of the Brand and the necessary analyses, we
                                    took care of the following interventions:
                                </p>
                                <ul role="list">
                                    <li>Writing texts</li>
                                    <li>create the site in 4 languages</li>
                                    <li>
                                        create the graphics of each page according to the best UI
                                        and UX (user interface and user experience)
                                    </li>
                                    <li>
                                        connect the site through programming interventions to the
                                        Gardalisa property management system
                                    </li>
                                    <li>
                                        take care of all UK English translations, from texts to
                                        details
                                    </li>
                                    <li>
                                        Develop the site and its transitions in every component
                                        and detail
                                    </li>
                                    <li>
                                        optimize the site according to the SEO strategy for
                                        google.it and google.com
                                    </li>
                                    <li>take care of marketing campaigns and the blog</li>
                                    <li>
                                        Create the coordinated image: business cards, signature,
                                        watermark for photos, document folder
                                    </li>
                                    <li>manage your blog and Google Advertising campaigns</li>
                                    <li>manage social media and Facebook ADS</li>
                                </ul>
                            </div>
                        </div>
                        <div class="article-image_block">
                            <img src="/assets/images/projects/673a508fbd397ea38a1e773f_V2-sito-768x538_atjiqo.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                        <div class="article-image_block">
                            <img src="/assets/images/projects/673a508fbd397ea38a1e774a_Gardalisa_2x-768x538_gvjhji.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                        <div class="article-image_block">
                            <img src="/assets/images/projects/673a508fbd397ea38a1e7747_LD_Gardalisa_Presentazione-21-768x543_xl9lhh.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                    <div class="article-block">
                        <div class="article-header">
                            <div>Coordinated image</div>
                            <div class="cc-underline quarter-width"></div>
                        </div>
                        <div class="header_content">
                            <div class="w-richtext">
                                <p>
                                    Business cards, document folders and covers for social
                                    media.
                                </p>
                                <p>
                                    The method we apply is always the same: 2 different graphic
                                    proposals, choice, executive and printing assistance.
                                </p>
                            </div>
                        </div>
                        <div class="article-image_block">
                            <img src="/assets/images/projects/673a508fbd397ea38a1e7766_V2-ipad-768x538_ac8ogp.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                </div>
...
useSeoMeta({
    ...
    ogDescription:
        "Real estate",
    ogImage:
        "https://cdn.prod.website-files.com/6732d301546e113668feb3eb/673a508fbd397ea38a1e774d_gardalisa_gienhw.webp",
})
</script>
