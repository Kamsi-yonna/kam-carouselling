            ...
            <div class="letter-hero_wrapper">
                <div class="letter-hero_details">
                    <div class="title_block">
                        <div class="blue-text_span">Mobiliar | interior design</div>
                    </div>
                ...
                <div class="hero-image_wrapper">
                    <div class="hero-image_block">
                        <img src="/public/assets/images/projects/673a508fdcc68218ba92b708_mobiliar_obqp7g.webp"
                ...
                <div class="project-content_block">
                    <div class="header_content">
                        <div class="w-richtext">
                            <p>
                                Alessandro De Stefani and his team at Mobiliar, a showroom of
                                major brands, but also an interior design consultant, located
                                in South Tyrol, contacted us to ask us to redo his website.
                                The aim is to renew the restyling and usability, make it in 2
                                languages, enhance the consultancy and design service that
                                Alessandro does for all his customers, as well as providing
                                high-end pieces of furniture and design.
                            </p>
                        </div>
                    </div>
                    <div class="article-block">
                        <div class="article-header">
                            <div>The Mobiliar reality</div>
                            <div class="cc-underline quarter-width"></div>
                        </div>
                        <div class="header_content">
                            <div class="w-richtext">
                                <p>
                                    The history of Alessandro and Mobiliar is made up of
                                    presence and collaboration, of seriousness in operating and
                                    designing, of constant updating, of concreteness and
                                    assistance in the choice and installation of the most
                                    advanced materials, above all in the ability to intercept
                                    and know how to translate people's tastes and needs.
                                </p>
                            </div>
                        </div>
                        <div class="article-image_block">
                            <img src="/public/assets/images/projects/673a508fdcc68218ba92b6fd_mobilart-1_shjvun.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                    <div class="article-block">
                        <div class="article-header">
                            <div>What we did: website creation</div>
                            <div class="cc-underline quarter-width"></div>
                        </div>
                        <div class="header_content">
                            <div class="w-richtext">
                                <p>
                                    We started with our analysis questionnaire, then we made 2
                                    design proposals complete with realistic mockups.
                                    <br /><br />Alessandro chose the one that is now perfected
                                    online. <br /><br />After designing the graphics for each
                                    page (User Interface – UI) taking into account the user
                                    experience, we moved on to development and all ancillary
                                    interventions. <br /><br />Alessandro is very happy and so
                                    are we, for satisfying him and for avoiding compromises to a
                                    minimum.
                                </p>
                            </div>
                        </div>
                        <div class="article-image_block">
                            <img src="/public/assets/images/projects/673a508fdcc68218ba92b70e_CSSDAwards_1068x646_nvxce2.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                    <div class="article-block">
                        <div class="article-header">
                            <div>Copywriting and translations for the website</div>
                            <div class="cc-underline quarter-width"></div>
                        </div>
                        <div class="header_content">
                            <div class="w-richtext">
                                <p>
                                    After our On-Stage questionnaire, we focused on copywriting
                                    in Italian, and later on professional translation into
                                    German.
                                </p>
                            </div>
                        </div>
                        <div class="article-image_block">
                            <img src="/public/assets/images/projects/673a508fdcc68218ba92b704_Portfolio_project_immagine-2_2x_maz7i7.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                    <div class="article-block">
                        <div class="article-header">
                            <div>Graphic start-up for social media</div>
                            <div class="cc-underline quarter-width"></div>
                        </div>
                        <div class="header_content">
                            <div class="w-richtext">
                                <p>
                                    Once the site was completed, the customer asked us for a
                                    graphic renewal of the social networks and management.
                                </p>
                                <p>
                                    In these cases, before starting the management, we give a
                                    coordinated image of social media to the site and implement
                                    that service that we call social start-ups.
                                </p>
                                <p>
                                    It allows you to start off on the right foot by studying and
                                    setting up an effective visual communication built on a
                                    business scale.
                                </p>
                                <p>It consisted of:</p>
                                <ul role="list">
                                    <li>definition of fixed points</li>
                                    <li>Goal Setting</li>
                                    <li>Analysis and research, target</li>
                                    <li>Identifying topics</li>
                                    <li>coordinated graphics: columns, posts, feeds, covers</li>
                                    <li>Presentation with mock-up of two graphic proposals</li>
                                    <li>
                                        development of the first 10 posts, columns, templates
                                    </li>
                                </ul>
                                <p>‍</p>
                            </div>
                        ...
                        <div class="article-image_block">
                            <img src="/public/assets/images/projects/673a508fdcc68218ba92b717_Schermata-2023-08-08-alle-10.56.47-1536x1043_sipm3z.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                        <div class="article-image_block">
                            <img src="/public/assets/images/projects/673a508fdcc68218ba92b70b_Schermata-2023-08-08-alle-10.56.56-1536x1050_nhvp4d.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                        <div class="article-image_block">
                            <img src="/public/assets/images/projects/673a508fdcc68218ba92b71a_Schermata-2023-08-08-alle-10.57.25_kwivsr.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                    <div class="article-block">
                        <div class="article-header">
                            <div>Social Media Management and Meta Advertising</div>
                            <div class="cc-underline quarter-width"></div>
                        </div>
                        <div class="header_content">
                            <div class="w-richtext">
                                <p>
                                    After the start-up, we took care of the management of
                                    Instagram and Facebook in German and advertising on Meta.
                                </p>
                            </div>
                        </div>
                        <div class="article-image_block">
                            <img src="/public/assets/images/projects/673a508fdcc68218ba92b71d_Schermata-2023-08-08-alle-10.57.07-1536x1188_fsijhz.webp"
                                loading="lazy" alt="" class="cc-image" />
                        </div>
                    </div>
                </div>
...
useSeoMeta({
    ...
    description:
        "The Mobiliar reality",
    ogDescription:
        "The Mobiliar reality",
    ogImage:
        "https://cdn.prod.website-files.com/6732d301546e113668feb3eb/673a508fdcc68218ba92b708_mobiliar_obqp7g.webp",
})
</script>
